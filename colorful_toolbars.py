...
sync_action.setToolTip(_(u"Synchronize with AnkiWeb. (Y)"))
...
decks_action.setToolTip(_(u"Go to the deck browser. (B)"))
...
overview_action.setToolTip(_(u"Go to the deck overview. (D)"))
...
study_action.setToolTip(_(u"Start studying the selected deck. (S)"))
...
add_notes_action.setToolTip(_(u"Add notes. (A)"))
...
browse_cards_action.setToolTip(_(u"Open the cards browser. (B)"))
...
statistics_action.setToolTip(_(u"Show statistics. (Shift+S)"))
...
edit_current_action.setToolTip(_(u"Edit the current note. (E)"))
...
delete_action.setToolTip(_(u"Delete this note. (Delete)"))
...
options_action.setToolTip(_(u"Show the active study options group. (O)"))
...
replay_action.setToolTip(_(u"Replay card’s audio or video. (R)"))
...
record_own_action.setToolTip(_(u"Record your own voice. (Shift+V)"))
...
replay_own_action.setToolTip(_(u"Replay your recorded voice. (V)"))
